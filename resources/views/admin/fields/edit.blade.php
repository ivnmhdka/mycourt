                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select name="category" id="category"
                                    ...
                                    <option value="Futsal" {{ old('category', $field->category) == 'Futsal' ? 'selected' : '' }}>
                                        Futsal
                                    </option>
                                    <option value="Badminton" {{ old('category', $field->category) == 'Badminton' ? 'selected' : '' }}>
                                        Badminton
                                    </option>
                                    <option value="Basketball" {{ old('category', $field->category) == 'Basketball' ? 'selected' : '' }}>
                                        Basketball
                                    </option>
                                </select>
                        ...
                        <div class="grid grid-cols-1 gap-6">
                            ...
                            <div class="mb-4">
                                ...
                                <textarea name="description" id="description" rows="4"
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline focus:border-blue-500 transition duration-150 ease-in-out">{{ old('description', $field->description) }}</textarea>
                                @error('description')
                                    <p class="text-red-500 text-xs italic mt-1">{{ $message }}</p>
                                @enderror
                            </div>
